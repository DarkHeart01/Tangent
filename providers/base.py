...
class EmbeddingProvider(ABC):
    """
    Optional capability, separate from LLMProvider since not every chat
    provider also serves embeddings. Providers that support it implement
    both interfaces (see GeminiAdapter).
    """
