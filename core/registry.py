...
def bootstrap_registries(
    ...
    - Register Groq, OpenRouter, Gemini, and/or OpenAI providers
    """
    ...
    if openai_api_key:
        openai = OpenAIAdapter(api_key=openai_api_key, default_model=default_model)
        pr.register("openai", openai, overwrite=True)
